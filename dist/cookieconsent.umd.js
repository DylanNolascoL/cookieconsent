...
(function (global, factory) {
    ...
    const createConsentModal = (api, createMainContainer) => {
        ...
        if (manageWithBTSBtn) {
            if (!dom._cmManageWithBTS) {
                ...
                addEvent(dom._cmManageWithBTS, CLICK_EVENT, () => {console.log('manageWithBTSBtn'); });
            }
    ...
    exports.show = show;
    exports.showCustomData = showCustomData;
